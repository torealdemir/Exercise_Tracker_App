"""
Django settings for backend_exercise_tracker project.
...
CORS_ALLOW_ALL_ORIGINS = True  # Allows all frontend domains (only for development)
...
ROOT_URLCONF = 'backend_exercise_tracker.urls'
...
WSGI_APPLICATION = 'backend_exercise_tracker.wsgi.application'
